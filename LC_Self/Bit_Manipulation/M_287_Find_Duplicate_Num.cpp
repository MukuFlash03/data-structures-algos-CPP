...
C. Bitwise XOR Approach

- First iteration of XOR from 1 to n gives sequential XOR of all numbers w/o duplicate number.
- Second iteration of XOR of all array elements gives sequential XOR of all numbers with duplicate number.
- Now for two identical numbers A and B, A ^ B = 0.
- Hence XOR of results of XORs of 1st and 2nd iteration results in cancelling out of pairwise non-duplicate numbers.
- Duplicate number remains as it is.
...
int findDuplicate(vector<int>& nums) {
   ...
   // Initialise X as 0 and update X = X ^ i at every iteration
    int X = 0;
