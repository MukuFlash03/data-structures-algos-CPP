...
int eraseOverlapIntervals(std::vector<std::vector<int>>& intervals) {
    ...
    sort(intervals.begin(), intervals.end(), [](std::vector<int>& i1, std::vector<int>& i2) {
        return i1[0] < i2[0];
    });
...
int main() {
    ...
    std::vector<std::vector<int>> nums = {{1,2},{1,2},{1,2}};
    // std::vector<std::vector<int>> nums = {{1,2},{2,3}};
    // std::vector<std::vector<int>> nums = {{1,100},{11,22},{1,11},{2,12}};
